...
QG_Data = np.load(r"../data/qg_data_topo1.npz")
...
for ep in range(1, epochs+1):
    ...
    if ep % 10 == 0:
        ...
        if val_loss_total < best_val_loss:
            ...
            torch.save(checkpoint, r"../model/CGKN_topo1_retrain_stage1.pt")
            status = "✅"
        else:
            status = ""
...
np.savez(r"../model/CGKN_topo1_retrain_loss_history.npz", **loss_history)
"""
...
# torch.cuda.empty_cache()
# torch.save(sigma_hat, "../data/CGKN_topo1_retrain_sigma_hat.pt")

sigma_hat = torch.load("../data/CGKN_topo1_retrain_sigma_hat.pt")
    ...
    if itr % val_per_itrs == 0:
        ...
        with torch.no_grad():
            ...
            if val_loss_total < best_val_loss:
                ...
                torch.save(checkpoint, "../model/CGKN_topo1_retrain_stage2.pt")
                status = "✅"
            else:
                status = ""
...
np.savez(r"../model/CGKN_topo1_retrain_loss_history_stage2.npz", **loss_history)
# """
...
np.save(r"../data/CGKN_topo1_retrain_xy_unit_OneStepPrediction.npy", test_u1_pred.to("cpu"))
np.save(r"../data/CGKN_topo1_retrain_psi_OneStepPrediction.npy", test_u2_pred.to("cpu"))
...
np.save(r"../data/CGKN_topo1_retrain_psi_DA.npy", test_mu_pred.to("cpu"))
