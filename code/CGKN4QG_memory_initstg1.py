...
sigma_hat = torch.zeros(dim_u1 + dim_z)
sigma_hat[:dim_u1] = torch.sqrt(torch.mean((train_u1[len_mem-1:].view(Ntrain-len_mem+1, -1)  - train_u1_pred)**2, dim=(0,1))).to("cpu")
...
# torch.save(cgkn, r"../model/QG(Noisy)_sigmaxy01_CGKN_dimz256_memory_initstg1_stage2.pt")
# np.save(r"../model/QG(Noisy)_sigmaxy01_CGKN_dimz256_memory_initstg1_train_loss_forecast_u1_history_stage2.npy", train_loss_forecast_u1_history)
# np.save(r"../model/QG(Noisy)_sigmaxy01_CGKN_dimz256_memory_initstg1_train_loss_forecast_u2_history_stage2.npy", train_loss_forecast_u2_history)
# np.save(r"../model/QG(Noisy)_sigmaxy01_CGKN_dimz256_memory_initstg1_train_loss_ae_history_stage2.npy", train_loss_ae_history)
# np.save(r"../model/QG(Noisy)_sigmaxy01_CGKN_dimz256_memory_initstg1_train_loss_forecast_z_history_stage2.npy", train_loss_forecast_z_history)
# np.save(r"../model/QG(Noisy)_sigmaxy01_CGKN_dimz256_memory_initstg1_train_loss_da_history_stage2.npy", train_loss_da_history)


cgkn = torch.load(r"../model/QG(Noisy)_sigmaxy01_CGKN_dimz256_memory_initstg1_stage2.pt").to(device)
...
np.save(r"../data/CGKN_sigmaxy01_memory_initstg1_xy_unit_OneStepPrediction.npy", test_u1_pred.to("cpu"))
np.save(r"../data/CGKN_sigmaxy01_memory_initstg1_psi_OneStepPrediction.npy", test_u2_pred.to("cpu"))
...
test_u1 = test_u1.to("cpu")
test_u2 = test_u2.to("cpu")
np.save(r"../data/CGKN_sigmaxy01_memory_initstg1_psi_DA.npy", test_mu_pred.to("cpu"))
