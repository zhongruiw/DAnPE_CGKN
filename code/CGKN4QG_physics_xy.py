...
torch.save(cgkn, r"../model/QG(Noisy)_64x64_sigmaxy01_CGKN_physics_dimz256_realxy_stage1.pt")
np.save(r"../model/QG(Noisy)_64x64_sigmaxy01_CGKN_physics_dimz256_realxy_train_loss_forecast_u1_history_stage1.npy", train_loss_forecast_u1_history)
np.save(r"../model/QG(Noisy)_64x64_sigmaxy01_CGKN_physics_dimz256_realxy_train_loss_forecast_u2_history_stage1.npy", train_loss_forecast_u2_history)
np.save(r"../model/QG(Noisy)_64x64_sigmaxy01_CGKN_physics_dimz256_realxy_train_loss_ae_history_stage1.npy", train_loss_ae_history)
np.save(r"../model/QG(Noisy)_64x64_sigmaxy01_CGKN_physics_dimz256_realxy_train_loss_forecast_z_history_stage1.npy", train_loss_forecast_z_history)
np.save(r"../model/QG(Noisy)_64x64_sigmaxy01_CGKN_physics_dimz256_realxy_train_loss_physics_history_stage1.npy", train_loss_physics_history)

# """
# cgkn = torch.load(r"../model/QG(Noisy)_64x64_sigmaxy01_CGKN_physics_dimz256_realxy_stage1.pt").to(device)
...
np.save(r"../data/CGKN_64x64_physics_realxy_sigmaxy01_xy_OneStepPrediction_stage1.npy", test_u1_pred.to("cpu"))
np.save(r"../data/CGKN_64x64_physics_realxy_sigmaxy01_psi_OneStepPrediction_stage1.npy", test_u2_pred.to("cpu"))
...
torch.save(cgkn, r"../model/QG(Noisy)_64x64_sigmaxy01_CGKN_physics_dimz256_realxy_stage2.pt")
np.save(r"../model/QG(Noisy)_64x64_sigmaxy01_CGKN_physics_dimz256_realxy_train_loss_forecast_u1_history_stage2.npy", train_loss_forecast_u1_history)
np.save(r"../model/QG(Noisy)_64x64_sigmaxy01_CGKN_physics_dimz256_realxy_train_loss_forecast_u2_history_stage2.npy", train_loss_forecast_u2_history)
np.save(r"../model/QG(Noisy)_64x64_sigmaxy01_CGKN_physics_dimz256_realxy_train_loss_ae_history_stage2.npy", train_loss_ae_history)
np.save(r"../model/QG(Noisy)_64x64_sigmaxy01_CGKN_physics_dimz256_realxy_train_loss_forecast_z_history_stage2.npy", train_loss_forecast_z_history)
np.save(r"../model/QG(Noisy)_64x64_sigmaxy01_CGKN_physics_dimz256_realxy_train_loss_da_history_stage2.npy", train_loss_da_history)
np.save(r"../model/QG(Noisy)_64x64_sigmaxy01_CGKN_physics_dimz256_realxy_train_loss_physics_history_stage2.npy", train_loss_physics_history)
...
np.save(r"../data/CGKN_64x64_physics_realxy_sigmaxy01_xy_OneStepPrediction.npy", test_u1_pred.to("cpu"))
np.save(r"../data/CGKN_64x64_physics_realxy_sigmaxy01_psi_OneStepPrediction.npy", test_u2_pred.to("cpu"))
...
test_u1 = test_u1.to("cpu")
test_u2 = test_u2.to("cpu")
np.save(r"../data/CGKN_64x64_physics_realxy_sigmaxy01_psi_DA.npy", test_mu_pred.to("cpu"))
