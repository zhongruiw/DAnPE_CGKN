...
for ep in range(1, epochs+1):
    ...
    if ep % 10 == 0:
        ...
        if val_loss_total < best_val_loss:
            ...
            torch.save(checkpoint, r"../model/CGKN_L1024_complex_long_simpleCGN_stage1.pt")
            status = "✅"
        else:
            status = ""
...
np.savez(r"../model/CGKN_L1024_complex_long_simpleCGN_loss_history.npz", **loss_history)
"""
checkpoint = torch.load("../model/CGKN_L1024_complex_long_simpleCGN_stage1.pt", map_location=device, weights_only=True)
...
# torch.save(sigma_hat, "../data/CGKN_L1024_complex_long_simpleCGN_sigma_hat.pt")
sigma_hat = torch.load("../data/CGKN_L1024_complex_long_simpleCGN_sigma_hat.pt", weights_only=True)
    ...
    if itr % val_per_itrs == 0:
        ...
        with torch.no_grad():
            ...
            if val_loss_total < best_val_loss:
                ...
                torch.save(checkpoint, "../model/CGKN_L1024_complex_long_simpleCGN_stage2.pt")
                status = "✅"
            else:
                status = ""
...
np.savez(r"../model/CGKN_L1024_complex_long_simpleCGN_loss_history_stage2.npz", **loss_history)
# """
...
torch.save(train_mu_pred, "../data/CGKN_L1024_complex_long_simpleCGN_train_mu_pred.pt")
...
}, "../model/UQNet_complex_long_simpleCGN.pt")
...
np.save(r"../data/CGKN_L1024_complex_long_simpleCGN_xy_unit_OneStepPrediction.npy", test_u1_pred.to("cpu"))
np.save(r"../data/CGKN_L1024_complex_long_simpleCGN_psi_OneStepPrediction.npy", test_u2_pred.to("cpu"))
...
test_u1 = test_u1.to("cpu")
test_u2 = test_u2.to("cpu")
np.save(r"../data/CGKN_L1024_complex_long_simpleCGN_psi_DA.npy", test_mu_pred.to("cpu"))
...
np.save(r"../data/CGKN_L1024_complex_long_simpleCGN_psi_DA_std.npy", test_mu_std_pred)
