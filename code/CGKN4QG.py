...
np.save(r"../data/CGKN_sigmaxy01_xy_unit_OneStepPrediction_stage1.npy", test_u1_pred.to("cpu"))
np.save(r"../data/CGKN_sigmaxy01_psi_OneStepPrediction_stage1.npy", test_u2_pred.to("cpu"))
