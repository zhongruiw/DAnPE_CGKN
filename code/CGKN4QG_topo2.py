...
QG_Data = np.load(r"../data/qg_data_topo2.npz")
# QG_Data = np.load(r"../data/qg_data_sigmaxy01_t2000.npz")

pos = QG_Data["xy_obs"][:, :128]
...
checkpoint = torch.load("../model/CGKN_stage2.pt", map_location=device, weights_only=False)
...
for ep in range(1, epochs+1):
    ...
    if ep % 2 == 0:
        ...
        if val_loss_total < best_val_loss:
            ...
            torch.save(checkpoint, r"../model/CGKN_topo2_retrain_stage1.pt")
            status = "✅"
        else:
            status = ""
...
np.savez(r"../model/CGKN_topo2_retrain_loss_history.npz", **loss_history)
# """
# checkpoint = torch.load("../model/CGKN_topo1_retrain_stage1.pt", map_location=device, weights_only=False)
# cgkn.load_state_dict(checkpoint['model_state_dict'])
...
# np.save(r"../data/CGKN_topo1_xy_unit_OneStepPrediction_stage1.npy", test_u1_pred.to("cpu"))
# np.save(r"../data/CGKN_topo1_psi_OneStepPrediction_stage1.npy", test_u2_pred.to("cpu"))

# np.save(r"../data/CGKN_topo1_retrain_xy_unit_OneStepPrediction_stage1.npy", test_u1_pred.to("cpu"))
# np.save(r"../data/CGKN_topo1_retrain_psi_OneStepPrediction_stage1.npy", test_u2_pred.to("cpu"))
...
torch.cuda.empty_cache()
torch.save(sigma_hat, "../data/CGKN_topo2_retrain_sigma_hat.pt")

# sigma_hat = torch.load("../data/CGKN_topo2_retrain_sigma_hat.pt")
    ...
    if itr % val_per_itrs == 0:
        ...
        with torch.no_grad():
            ...
            if val_loss_total < best_val_loss:
                ...
                torch.save(checkpoint, "../model/CGKN_topo2_retrain_stage2.pt")
                status = "✅"
            else:
                status = ""
...
np.savez(r"../model/CGKN_topo2_retrain_loss_history_stage2.npz", **loss_history)
# """

# checkpoint = torch.load("../model/CGKN_topo2_retrain_stage2.pt", map_location=device)
# cgkn.load_state_dict(checkpoint['model_state_dict'])
...
# np.save(r"../data/CGKN_topo1_xy_unit_OneStepPrediction.npy", test_u1_pred.to("cpu"))
# np.save(r"../data/CGKN_topo1_psi_OneStepPrediction.npy", test_u2_pred.to("cpu"))

np.save(r"../data/CGKN_topo2_retrain_xy_unit_OneStepPrediction.npy", test_u1_pred.to("cpu"))
np.save(r"../data/CGKN_topo2_retrain_psi_OneStepPrediction.npy", test_u2_pred.to("cpu"))
...
test_u1 = test_u1.to("cpu")
test_u2 = test_u2.to("cpu")
# np.save(r"../data/CGKN_topo1_psi_DA.npy", test_mu_pred.to("cpu"))

np.save(r"../data/CGKN_topo2_retrain_psi_DA.npy", test_mu_pred.to("cpu"))
