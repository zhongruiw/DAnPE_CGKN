...
class CGN(nn.Module):
    def __init__(self, dim_u1, dim_z):
        ...
        # self.net2 = nn.Sequential(nn.Linear(self.input_size2, 64), nn.SiLU(),
        #                  nn.Linear(64, 128), nn.SiLU(),
        #                  nn.Linear(128, 64), nn.SiLU(),
        #                  nn.Linear(64, self.output_size2))
...
torch.save(cgkn, r"../model/QG(Noisy)_sigmaxy01_continuousxy_CGKN_dimz256_stage1.pt")
np.save(r"../model/QG(Noisy)_sigmaxy01_continuousxy_CGKN_dimz256_train_loss_forecast_u1_history_stage1.npy", train_loss_forecast_u1_history)
np.save(r"../model/QG(Noisy)_sigmaxy01_continuousxy_CGKN_dimz256_train_loss_forecast_u2_history_stage1.npy", train_loss_forecast_u2_history)
np.save(r"../model/QG(Noisy)_sigmaxy01_continuousxy_CGKN_dimz256_train_loss_ae_history_stage1.npy", train_loss_ae_history)
np.save(r"../model/QG(Noisy)_sigmaxy01_continuousxy_CGKN_dimz256_train_loss_forecast_z_history_stage1.npy", train_loss_forecast_z_history)

"""
cgkn = torch.load(r"../model/QG(Noisy)_sigmaxy01_continuousxy_CGKN_dimz256_stage1.pt").to(device)
...
torch.save(cgkn, r"../model/QG(Noisy)_sigmaxy01_continuousxy_CGKN_dimz256_stage2.pt")
np.save(r"../model/QG(Noisy)_sigmaxy01_continuousxy_CGKN_dimz256_train_loss_forecast_u1_history_stage2.npy", train_loss_forecast_u1_history)
np.save(r"../model/QG(Noisy)_sigmaxy01_continuousxy_CGKN_dimz256_train_loss_forecast_u2_history_stage2.npy", train_loss_forecast_u2_history)
np.save(r"../model/QG(Noisy)_sigmaxy01_continuousxy_CGKN_dimz256_train_loss_ae_history_stage2.npy", train_loss_ae_history)
np.save(r"../model/QG(Noisy)_sigmaxy01_continuousxy_CGKN_dimz256_train_loss_forecast_z_history_stage2.npy", train_loss_forecast_z_history)
np.save(r"../model/QG(Noisy)_sigmaxy01_continuousxy_CGKN_dimz256_train_loss_da_history_stage2.npy", train_loss_da_history)


# cgkn = torch.load(r"../model/QG(Noisy)_sigmaxy01_continuousxy_CGKN_dimz256_stage2.pt").to(device)
...
np.save(r"../data/CGKN_sigmaxy01_continuousxy_xy_unit_OneStepPrediction.npy", test_u1_pred.to("cpu"))
np.save(r"../data/CGKN_sigmaxy01_continuousxy_psi_OneStepPrediction.npy", test_u2_pred.to("cpu"))
...
test_u1 = test_u1.to("cpu")
test_u2 = test_u2.to("cpu")
np.save(r"../data/CGKN_sigmaxy01_continuousxy_psi_DA.npy", test_mu_pred.to("cpu"))
